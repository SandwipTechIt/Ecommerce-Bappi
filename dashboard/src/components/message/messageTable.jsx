...
export default ({ messages, onDeleteMessage }) => {
    ...
    const handleConfirmDelete = async () => {
        try {
            await onDeleteMessage(deleteConfirm);
            ...
            <table className="w-full border-collapse bg-white dark:bg-gray-800">
                ...
                <thead className="hidden md:table-header-group">
                    <tr>
                        ...
                        <th className="bg-[#721c24] p-4 text-left text-white">Subject</th>
                        <th className="bg-[#721c24] p-4 text-left text-white">Number</th>
                        <th className="bg-[#721c24] p-4 text-left text-white">Message</th>
