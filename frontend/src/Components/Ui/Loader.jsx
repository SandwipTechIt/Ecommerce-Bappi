...
<div role="status" className="flex items-center justify-center mt-16">
    <svg aria-hidden="true" className="w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#e75c3a]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//     // Generate 8 skeleton items (adjust as needed)
//     const skeletons = Array.from({ length: 8 }, (_, i) => <ProductSkeleton key={i} />);
