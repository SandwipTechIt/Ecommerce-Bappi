        ...
        <div id="productCard">
            <Link to={`/product/${product.slug}`} className="block h-full">
                <div className="relative overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 bg-white h-full flex flex-col">
                    {product.status && (
                        <div className="absolute top-2 right-2 bgPrimary text-white text-xs font-semibold px-3 py-1 rounded-md z-1">
                            {product.status}
                        </div>
                    )}
                            ...
                            <div className="flex justify-between items-center gap-2 mb-3  flex-wrap">
                                ...
                                <div className="flex justify-center flex-1">
                                    <button
                                        ...
                                        className="w-full bgPrimary text-white font-semibold py-2 px-4 rounded-md flex items-center justify-center gap-2 transition-colors duration-200"
                                    >
